...
fun LoadScreen(
    ...
    val checkDeviceDataSuccess by loadViewModel.checkDeviceDataSuccess.collectAsState()

    LaunchedEffect(Unit) {
        loadViewModel.checkDeviceData()
    }

    LaunchedEffect(checkDeviceDataSuccess) {
        if (checkDeviceDataSuccess == true) {
            onNavigateToHome()
        }
    }
