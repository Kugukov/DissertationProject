...
import com.example.mainproject.presentation.component.IconButtonForTaleCard
...
fun ChildButtonsAudioTale(
    ...
    Row(
        ...
        IconButtonForTaleCard(
            imageVector = icon,
            iconContentDescription = if (!isThisPlaying) "Play" else "Stop",
